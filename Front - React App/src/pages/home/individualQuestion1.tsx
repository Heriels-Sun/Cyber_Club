  ...
  return (
    <Box p="4" borderRadius="md" my="4" overflowX="auto" minW="0" maxW="100%">
      <FormControl as="fieldset">
        ...
        <HStack spacing="27vh" alignItems="center" w="100%" h="35vh">
          <Box color="white" paddingLeft="3vh" w="58vh" h="12vh" fontSize="30px" textAlign="justify">{text}</Box>
          <Image w="34vh" h="20vh" src="https://online.stanford.edu/sites/default/files/inline-images/1600X900-How-does-blockchain-work.jpg" alt="Blockchain"/>
        </HStack>

        <RadioGroup defaultValue="" mt="2vh" color="white">
          <HStack spacing="50px" mb="2vh">
            <Button whiteSpace="pre-line"
              backgroundColor={selectedAnswer === '1' ? '#434F74' : '#2B3048'}
              w="63.9vh"
              h="11vh"
              borderRadius="md"
              textAlign="center"
          ...
          <HStack spacing="50px">
            <Button whiteSpace="pre-line"
              backgroundColor={selectedAnswer === '3' ? '#434F74' : '#2B3048'}
              w="63.9vh"
              h="11vh"
              borderRadius="md"
              textAlign="center"
            ...
            <Button whiteSpace="pre-line"
              backgroundColor={selectedAnswer === '4' ? '#434F74' : '#2B3048'}
              w="63.9vh"
              h="11vh"
              borderRadius="md"
              textAlign="center"
